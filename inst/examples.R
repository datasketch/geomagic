...
gg_choropleth_map_GnmNum.(data = NULL, mapName = "col_dc_districts")
gg_choropleth_map_GnmNum.(data = NULL, mapName = "col_departments")
gg_choropleth_map_GnmNum.(data = NULL, mapName = "col_municipalities")
gg_choropleth_map_GnmNum.(data = NULL, mapName = "cri_provinces")
gg_choropleth_map_GnmNum.(data = NULL, mapName = "latam_countries")
gg_choropleth_map_GnmNum.(data = NULL, mapName = "mex_states")
...
gg_choropleth_map_GnmNum.(data = NULL, mapName = "world_countries", opts = opts)


deptos <- c("05", "08", "11", "13", "15", "17", "18", "19", "20", "23", "25", "27", "41", "44", "47", "50")
dataGnmNum <- data.frame(id = deptos, num = runif(length(deptos), 0, 1))
gg_choropleth_map_GnmNum.(data = dataGnmNum, mapName = "col_departments")
...
#
# gg_choropleth_latam_GnmNum.(dataGnmNum1.1, color_frontier = 'black', prop_text = 'all')
#
# lat_max <- 6.276997
# long_max <- -69.635037
# lat_min <- 2.342537
